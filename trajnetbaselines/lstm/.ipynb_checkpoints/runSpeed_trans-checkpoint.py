...
class Trainer(object):
    ...
    def attack_batch(self, xy, goals, batch_split, thread_index=None, scene_id = None):
        ...
        while (counter != 0):
            ...
            rel_outputs_perturbed1, outputs_perturbed1 = local_model1(perturbed_observation, goals.clone(), batch_split,n_predict=12)
            # Clear NaNs
            ...
            best_score_by_now1 = min(best_score_by_now1,score1.item())
        ...
        if best_score_by_now < collision_done_barrier and best_score_by_now1 < collision_done_barrier:
