...
class Trainer(object):
    ...
    def attack_batch(self, xy, goals, thread_index=None, scene_id = None, batch_split=None):
        ...
        while (counter != 0):
            ...
            rel_outputs_perturbed1, outputs_perturbed1 = local_model1(perturbed_observation, goals.clone(), batch_split,
                                                                      n_predict=12)
            # Clear NaNs
            ...
            distances, timeCollo, frame_index, neighbor_index, score,timeScore = self.getFrame(agents_count, outputs_perturbed)
            distances1, timeCollo1, frame_index1, neighbor_index1, score1, timeScore1 = self.getFrame(agents_count,
                                                                                                outputs_perturbed1)
        ...
        if best_score_by_now < collision_done_barrier and best_score_by_now1 < 0.2:
    ...
    def getFrame(self, agents_count, outputs_perturbed):
        ...
        # Score
        timeScore = torch.min(timeCollo).data
        ...
        return distances,timeCollo, frame_index, neighbor_index, score,timeScore
...
def main(epochs=50):
    ...
    # the second model
    parser.add_argument('--type1', default='s_lstm',
                        choices=('s_lstm', 'd_pool', 's_att'),
                        help='type of LSTM to train')
    ...
    # generator
    lstm_generator1 = LSTMGenerator(embedding_dim=args.coordinate_embedding_dim, hidden_dim=args.hidden_dim,
    ...
    print("Loading Model Dict from ", load_address1)
    ...
    print("Successfully Loaded model1")
